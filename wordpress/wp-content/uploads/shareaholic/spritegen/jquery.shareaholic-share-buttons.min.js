...
g=b.attr("data-shr_lang"),h="shr-7",j="shr-generic",k=true,i=true;SHR4P.debug(b);if(typeof f=="undefined"||!f)f="horizontal";if((typeof c=="undefined"||!c)&&(typeof e=="undefined"||!e)){c=encodeURIComponent(document.location.href);e=document.title}else{if(typeof c=="undefined"||!c)c=encodeURIComponent(document.location.href);if(typeof e=="undefined"||!e)e=""}if(typeof d=="undefined"||!d)d="standard";var m="";d=="medium"&&(m="padding-top:1px !important;");if(typeof g=="undefined"||!g)g="en";switch(f){case "horizontal":i=
