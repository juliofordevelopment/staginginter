...
"")):0;a["bgimg-padding-left"]=c[3]?Number(c[3].replace(/[a-zA-Z]+/,"")):0;a["margin-left"]=10}if(a.localize)a.iframe_src="/publishers.html";var e=function(){var g=0;if(!b.isEmptyObject(a.custom_link))g=b(a.custom_link).length;return a.service.split(",").length+g},d=function(){return a["margin-left"]+a["bgimg-padding-left"]},f=function(b){return Math.ceil(e()/Math.floor((b-d())/a["icon-width"]))},g=function(b){return a.expand?a["margin-top"]+a["bgimg-padding-top"]+a["icon-height"]+a["icon-margin-top"]+
(f(b)==1?a["promo-height"]:0):h(b)},h=function(b){return a["margin-top"]+a["bgimg-padding-top"]+(a["icon-height"]+a["icon-margin-top"])*f(b)+a["promo-height"]},j=function(b){SHR4P.debug("centering");var g=0;if(f(b)==1){SHR4P.debug("one row! do centering");g=(b-d()-e()*a["icon-width"])/2;SHR4P.debug("returning "+g+" margin")}return g};this.each(function(){if(a.spaced){var c=b(this).width();SHR4P.debug("spacing");SHR4P.debug("rows: "+f(c));var k=0;if(f(c)==1){SHR4P.debug("one row! spacing icons");k=
Math.floor((c-d()-a["icon-width"]*e())/e());SHR4P.debug("returning "+k+" margin")}a.li_margin=k}c={src:a.src,service:a.service,apikey:a.apikey,link:a.link,title:a.title,notes:a.notes,bgimg:a.bgimg,bgimg_padding:a.bgimg_padding,rel:a.rel,target:a.target,twitter_template:a.twitter_template,localize:a.localize,share_src:a.share_src,spriteimg:a.spriteimg,tags:a.tags,allowExternalTags:a.allowExternalTags,designer_toolTips:a.designer_toolTips,tip_bg_color:a.tip_bg_color,tip_text_color:a.tip_text_color,
...
height:g(b(this).width()),width:b(this).width(),scrolling:"no","class":"share-iframe"}).css({height:h(b(this).width())}));if(a.expand){b(this).css({overflow:"hidden",height:g(b(this).width())});b(this).hover(function(){b(this).animate({height:h(b(this).width())},{duration:a.duration,queue:false})},function(){b(this).animate({height:g(b(this).width())},{duration:a.duration,queue:false})})}});return this};SHR4P.debug("initializing shareaholic plugin");b.fn.shareaholic=function(c){var a=b.extend({service:"",
rel:"nofollow",target:"_blank",poller_timeout:200,link:"",title:"",notes:"",bgimg:"",bgimg_padding:"",twitter_template:"${title} - ${short_link}",tags:"",category:"",ctype:"",localize:false,custom_link:{},li_margin:0,share_src:SHR4P.base_url,src:SHR4P.base_url,api:{share:{v:"1",url:"/api/share/",apitype:"1",source:"Shareaholic-Publishers"},sprite:{v:"2",url:"/api/sprite/"}},short_link:"",shortener:"google",shortener_key:"",shortener_services:{"bit.ly":function(a,b){var g=function(){SHR4P.debug("bitly javascript loaded");
var g=a.link;BitlyCB.mycallback=function(a){SHR4P.debug("bit.ly calls back with");SHR4P.debug(a);if(a.errorCode==0){SHR4P.debug("successfully shortened, calling callback with: ");a=a.results[g].shortUrl;SHR4P.debug("short_link: "+a);SHR4P.debug("type: "+typeof a);b(a)}};BitlyClient.call("shorten",{longUrl:g},"BitlyCB.mycallback")};if(typeof BitlyClient=="undefined"){SHR4P.debug("loading bit.ly");var c=document.getElementsByTagName("head")[0];if(typeof c!="undefined"){var h=a.shortener_key.split("|"),
d=document.createElement("script");d.src="http://bit.ly/javascript-api.js?version=latest&login="+h[0]+"&apiKey="+h[1];d.type="text/javascript";d.charset="utf-8";c.appendChild(d);d.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded"){SHR4P.debug("bit.ly loaded with onreadystatechange, init'ing");g()}};d.onload=g}}else{SHR4P.debug("bit.ly already loaded.  init'ing");g()}}}},c);SHR4P.debug("$.fn.shareaholic called");SHR4P.debug(a);b(this).addClass("shareaholic-show-on-load");
if(a.localize==true||a.localize=="true")a.localize=true;if(!a.link||a.link&&a.link==="")a.link=b(this).attr("data-shr_href")||document.location.href;if(!a.title||a.title&&a.title==="")a.title=b(this).attr("data-shr_title")||document.title;var e=function(a,g){return[a,b.param(g)].join("?")},c=function(a){for(var b=[],g=a.length,c=0;c<g;c++){for(var d=c+1;d<g;d++)a[c]===a[d]&&(d=++c);b.push(a[c])}return b},d=function(a,g,c){var d=c.designer_toolTips?"orig_title":"title",h=c.custom_link[a+"_"+g];SHR4P.debug("adding link "+
a+" "+g);return b("<li/>").addClass(h.li_class).append(b("<a/>").attr({href:h.link,rel:c.rel,target:c.target,"class":"external"}).attr(d,h.tooltip).text(h.tooltip)).attr("style",h.style+";margin-left:"+c.li_margin+"px !important;")},f=a.localize?a.src+"/sprite.css":e(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,service:c(a.service.split(",")).sort().join(",")});b("#shareaholic-publisher-css").length==0&&b("head").append(b('<link rel="stylesheet" media="screen" id="shareaholic-publisher-css" href="'+
f+'"/>'));var g=b("<div/>").addClass("shr-bookmarks").append(b("<ul/>").addClass("shr-socials"));if(a.shrlink){f=b.getBrowser();if(f!=""){g.append(b('<div style="clear: both;"></div><div class="shr-getshr" style="visibility:hidden;font-size:10px !important"><a target="_blank" href="http://www.shareaholic.com/?src=pub">Get Shareaholic</a></div><div style="clear: both;"></div>'));g.find(".shr-getshr a").text("Get Shareaholic for "+f);b(this).hover(function(){g.find(".shr-getshr").css("visibility","visible")},
function(){g.find(".shr-getshr").css("visibility","hidden")})}}a.bgimg!="undefined"&&a.bgimg!=""&&g.addClass("shr-bookmarks-bg-shr").css({"margin-left":"10px",height:"100%","overflow-x":"hidden","overflow-y":"hidden",display:"block",padding:a.bgimg_padding,background:"transparent url("+a.bgimg+") no-repeat"});var h=g.find(".shr-socials");if(a.fbLikeButton){setTimeout("SHR4P.fbUtil.addFBConnect()",0);var f=b('<div class="shareaholic-like-buttons"><br/></div>'),j=b('<a class="shareaholic-fb-like" style="margin-top:5px; margin-bottom:5px;"></a>');
SHR4P.fbUtil.addLikeButton(j,a.link);f.prepend(j);a.fbButtonPos.indexOf("bottom")!=-1?f.insertAfter(this):f.insertBefore(this);a.fbButtonPos.indexOf("right")!=-1&&j.css("float","right")}b(a.service.split(",")).each(function(g,c){var j="";if(c=="7")j=a.twitter_template;a.custom_link["before_"+g]&&d("before",g,a).appendTo(h);var i=a.designer_toolTips?"orig_title":"title",f=SHR4P.utils.getBrowserLocale(),f=f.split("-")[0];if(typeof SHR4P.locales!=="undefined"&&(typeof SHR4P.locales[f]=="undefined"||
!SHR4P.locales[f]))f="en";f=typeof SHR4P.locales!=="undefined"?SHR4P.locales[f][SHR4P.tooltips_prefix_map[c]]+" "+SHR4P.tooltips_suffix[c]:"";SHR4P.ga.socialAction({serviceId:c,serviceAction:"render",link:a.link});var k=b("<li/>");k.addClass("shr-"+c).addClass("shareaholic").attr("style","margin-left:"+a.li_margin+"px !important;").bind("click",{serviceId:c,serviceAction:"share",link:a.link},SHR4P.ga.trackAction);var l={title:a.title,link:a.link,notes:a.notes,short_link:a.short_link,shortener:a.shortener,
shortener_key:a.shortener_key,v:a.api.share.v,apitype:a.api.share.apitype,apikey:a.apikey,source:a.api.share.source,template:j,service:c,ctype:a.ctype};c=="7"&&a.twitter_overlay&&!SHR4P.utils.isMobileBrowser()?k.append(b("<a/>").attr({rel:a.rel,target:a.target,"class":"external"}).attr(i,f).text(f).click(function(b){SHR4P.utils.showServiceLet(a,"twitter");b.preventDefault()})).appendTo(h):k.append(b("<a/>").attr({href:e(a.share_src+a.api.share.url,l),rel:a.rel,target:a.target,"class":"external"}).attr(i,
f).text(f)).appendTo(h);c=="309"&&k.click(function(a){SHR4P.utils.runBookmarklet(l);a.preventDefault()});if(!a.dontShowShareCount&&(c==5||c==7||c==2||c==88||c==309)){j="https:"==document.location.protocol?1:0;i=function(a){a=a.count;if(a>0||a!="0"&&a!=0){for(var g=b("<div/>").addClass("shr-count").appendTo(h.find(".shr-"+c)),d=0;d<9;d=d+1)d!=4&&g.append(b("<div>"+a+"</div>").addClass("shr-count-outline").css({left:10+d%3-1+"px",top:"-"+(11+parseInt(d/3)-1)+"px"}).attr("aria-hidden","true"));g.append(b("<div>"+
...
i,j,"www.linkedin.com/countserv/count/share?url=",1,"ln"):c==309&&SHR4P.utils.getGenericShrCnt(a.link,i,j,"api.pinterest.com/v1/urls/count.json?url=",1,"pt")}a.custom_link["after_"+g]&&d("after",g,a).appendTo(h)});var i,k=b("<div style='position:absolute !important; background: transparent !important; z-index:101 !important;'/>"),l=b("<div class = 'shareaholic-tip-text'></div>"),f=b("<div class = 'shareaholic-arrow-down'/>");k.append(l);k.append(f);i={show:function(a){if(!b("body").find(".shareaholic-tip-text").length){var c=
b(a).find("a").attr("orig_title");l.text(c);c=b(a).offset();k.appendTo(document.body);var g=k.width(),a=b(a).width();k.css({left:c.left-g/2+a/2,top:c.top-32});k.css({opacity:0.9})}},hide:function(){k.remove()}};if(a.designer_toolTips){b("<style type='text/css'>.shareaholic-arrow-down{ position: absolute !important; left:45% !important; width: 0 !important; height: 0 !important; border-left: 6px solid transparent !important; border-right: 6px solid transparent !important; border-top: 6px solid "+a.tip_bg_color+
" !important; }.shareaholic-tip-text{font-size:12px !important; line-height:120% !important; background: "+a.tip_bg_color+" !important; color: "+a.tip_text_color+" !important; padding: 5px !important; border-radius: 5px !important; -webkit-border-radius:5px; !important; -moz-border-radius:5px; !important}</style>").appendTo("head");h.find("li").mouseenter(function(a){i.show(a.currentTarget)}).mouseleave(function(a){i.hide(a.currentTarget)})}f=function(a){b(h).find("li a").each(function(){this.href=
this.href+"&tags="+a})};a.allowExternalTags?SHR4P.utils.getTags(a.link,a.tags,f):f(a.tags);if(a.spriteimg!="")c=a.spriteimg;else if(a.localize)c=a.src+"/sprite.png";else{var f=function(a,b){return a-b},n=c(a.service.split(",")).sort(f);SHR4P.debug("checking services: ");SHR4P.debug(n);var m=[];b(SHR4P.img_group).each(function(){var a=this;SHR4P.debug("checking img_group: ");SHR4P.debug(a);b(n).each(function(){SHR4P.debug("checking service: "+this);if(b.inArray(Number(this),a)>-1){SHR4P.debug("found! adding img_group");
b.merge(m,a);return false}});SHR4P.debug("req_services so far: ");SHR4P.debug(m)});SHR4P.debug("final req_services: ");m=m.sort(f);SHR4P.debug(m.join(","));c=e(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,apitype:"png",service:m.join(",")})}g.append(b('<style type="text/css">ul.shr-socials li.shareaholic{background-image:url('+c+") !important;}</style>"));g.appendTo(this);return this};b.extend({getBrowser:function(){var b=navigator.userAgent,a="";b.indexOf("MSIE")!=-1?a="Internet Explorer":
...
SHR4P.params=function(){var b={},c=document.location.href.split("?");if(c.length==2)for(var c=c[1].split("&"),a=0;a<c.length;a++){var e=c[a].split("=");e.length==2&&(b[unescape(e[0])]=unescape(e[1]))}return b};SHR4P.debug=function(b){SHR.debug_enabled&&(typeof console!="undefined"&&console?console.log(b):alert(b))};
...
SHR4P.utils=function(b,c){function a(a,b){return[a,d.param(b)].join("?")}function e(a){if(!a.src)throw"Invalid source";a=d.extend({},{async:true,cache:false,src:false,id:""},a);if(!a.cache){a.r=Math.floor(Math.random()*9999999999);a.src=a.src+("&_="+a.r);a.id=a.id+a.r}var b=c.createElement("script");b.setAttribute("language","javascript");b.id=a.id;b.async=a.async;b.setAttribute("src",a.src);c.body.appendChild(b);return a}var d,f={v:1,apikey:"0747414f47c2b684cf5480c36b2478689",apitype:1,title:"",
link:"",short_link:"",shortener:"google",shortener_key:"",template:"${title} - ${short_link}",service:false,source:"Shareaholic-Publishers",tags:"",ctype:"",notes:""};return{init:function(a){d=a},url:a,appendScript:e,runBookmarklet:function(b){if(typeof b.service!="undefined"&&b.service){b.apitype=4;var c=SHR4P.base_url+"/api/share",j=d.extend({},f,b);e({src:a(c,j),cache:false,id:b.service+"_shareaholic_"})}},getFbShrCnt:function(a,b){if(typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption==
...
a.apikey:"0747414f47c2b684cf5480c36b2478689";SHR_config.twitter_template=a.twitter_template?a.twitter_template:"${title} - ${short_link}";SHR_config.link=a.link?a.link:c.location.href;SHR_config.title=a.title?a.title:a.link?"":c.title;SHR_config.short_link=a.short_link?a.short_link:"";b.SHR&&b.SHR.Servicelet?SHR.Servicelet.show():e({src:(a.share_src?a.share_src:SHR4P.cdn_url)+"/media/js/servicelet.min.js",cache:true,id:"shr-servicelet"})}},isMobileBrowser:function(){var a=navigator.userAgent||navigator.vendor||
...
SHR4P.ga=function(){function b(b){!a&&c();if(!d)return false;var e=b.serviceAction||"unknown",k=typeof g[e]!=="undefined"?g[e]:true,l=b.link,b=f+(SHR4P.tooltips_suffix[b.serviceId]||""),b=b.replace(/(\s|\r\n|\n|\r)/gm,"_"),e=e.charAt(0).toUpperCase()+e.slice(1);k&&_gaq.push([h+"_trackSocial",b,e,l]);return k}function c(){if(typeof _gaq=="undefined"||!_gaq)window._gaq=[];_gaq.push(["shr._setAccount","UA-12964573-5"],["shr._trackPageview"]);if(typeof SHRSB_Globals!=="undefined"){(e=SHRSB_Globals.pubGaKey||
false)&&(h="shrpub.");d=typeof SHRSB_Globals.pubGaSocial!=="undefined"?SHRSB_Globals.pubGaSocial:d;e&&d&&_gaq.push([h+"_setAccount",e])}a=true;if(typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"){var b=document.createElement("script");b.type="text/javascript";b.async=true;b.src=("https:"==document.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js";var c=document.getElementsByTagName("script")[0];c.parentNode.insertBefore(b,c)}}var a=false,e,d=true,f="Shareaholic_",
g={render:false,like:true,unlike:true,send:true,share:true,unknown:false},h="";return{init:c,socialAction:b,trackAction:function(a){b(a.data)}}}();
SHR4P.dough=SHR4P.dough||function(b,c){return function(){if(typeof SHRSB_Globals!="undefined"&&SHRSB_Globals.perfoption=="1"){var a;if(!(a=b.SHR_Load_Dough)){a=c.createElement("script");a.type="text/javascript";a.async=true;a.src=("https:"==document.location.protocol?"https://":"http://")+"dtym7iokkjlif.cloudfront.net/dough/1.0/recipe.js";var e=c.getElementsByTagName("script")[0];e.parentNode.insertBefore(a,e);a=true}b.SHR_Load_Dough=a}}}(window,document);
...
".shareaholic-like-buttonset").each(function(){var b=SHR4P.jQuery(this);if((b.attr("data-shr_status")||false)!="1"){var c=b.attr("data-shr_href")||b.attr("shr_href"),a=b.attr("data-shr_title")||b.attr("shr_title"),e=b.attr("data-shr_size")||b.attr("shr_size"),d=b.attr("data-shr_count")||b.attr("shr_count"),f=b.attr("data-shr_annotation"),g=b.attr("data-shr_width"),h=b.attr("data-shr_expandto"),j=b.attr("data-shr_onstartinteraction"),i=b.attr("data-shr_onendinteraction");if(typeof d=="undefined"||
!d)d="true";if((typeof c=="undefined"||!c)&&(typeof a=="undefined"||!a)){c=encodeURIComponent(document.location.href);a=document.title}else{if(typeof c=="undefined"||!c)c=encodeURIComponent(document.location.href);if(typeof a=="undefined"||!a)a=""}if(typeof e=="undefined"||!e)e="standard";if(typeof f=="undefined"||!f){f="bubble";f=typeof d!=="undefined"&&d&&d!=="false"?"bubble":"none"}if(typeof g=="undefined"||!g)g="450px";if(typeof h=="undefined"||!h)h="";if(typeof j=="undefined"||!j)j="";if(typeof i==
"undefined"||!i)i="";d="";e=="medium"&&(d="padding-top:1px !important;");b.attr("data-shr_status","1");d=SHR4P.jQuery("<div style='float:left; "+d+" margin:0px 0px 0px 10px !important;'/>").get(0);b.replaceWith(d);SHR4P.jQuery(d).append("<div/>");d=SHR4P.jQuery(d).find(":first-child").get(0);gapi.plusone.render(d,{size:e,annotation:f,width:g,expandto:h,onstartinteraction:j,onendinteraction:i,href:decodeURIComponent(c),callback:function(b){SHR4P.googPlusOneUtil.trackPlusOneClick(b,a)}});SHR4P.ga.socialAction({serviceId:304,
...
if(typeof a=="undefined"||!a)a="button_count";var e=b.attr("data-shr_showfaces");if(typeof e=="undefined"||!e)e="true";var d=b.attr("data-shr_send");if(typeof d=="undefined"||!d)d="false";var f=b.attr("data-shr_action");if(typeof f=="undefined"||!f||f.toLowerCase()!="recommend"&&f.toLowerCase()!="like")f="like";var g=SHR4P.jQuery("<div style='float:left;padding-top:0px !important; margin:0px 5px !important;'/>").get(0);b.replaceWith(g);if(SHR4P.fbUtil.hasFBNameSpace()){a=SHR4P.jQuery('<fb:like action="'+
f+'" send = "'+d+'" href="'+c+'"layout="'+a+'" show_faces="'+e+'" width="60" font=""></fb:like>').appendTo(g);typeof window.FB!="undefined"&&(FB.XFBML&&FB.XFBML.parse)&&FB.XFBML.parse(a.get(0))}else{b="30";d="60";switch(a){case "button_count":d="90";b="21";break;case "box_count":d="60";b="90";break;default:d="60";b="80"}SHR4P.jQuery('<iframe src="https://www.facebook.com/plugins/like.php?app_id=207766518608&amp;href='+c+"&amp;send=false&amp;layout="+a+"&amp;width="+d+"&amp;show_faces="+e+"&amp;action="+
f+"&amp;colorscheme=light&amp;font&amp;height="+b+'" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:'+d+"px; height:"+b+'px;" allowTransparency="true"></iframe>').appendTo(g)}SHR4P.ga.socialAction({serviceId:5,serviceAction:"render",link:c})})},addFBConnect:function(){SHR4P.fbUtil.addFBNameSpace();if(!SHR4P.fbUtil.fbConnectAdd){SHR4P.jQuery('<div id="fb-root"></div>').appendTo("body");window.fbAsyncInit=function(){FB.init({appId:"207766518608",status:true,cookie:true,xfbml:true});
