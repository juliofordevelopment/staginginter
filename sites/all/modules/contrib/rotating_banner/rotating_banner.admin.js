// $Id: rotating_banner.admin.js,v 1.28 2010/04/16 15:44:41 JacobSingh Exp $
(function ($) {
...
Drupal.behaviors.RotatingBannerSlideEdit = {
  attach: function (context) {
    ...
    $('#rb-add-headline').bind('click', function() {
      return Drupal.behaviors.RotatingBannerSlideEdit.newText({type: 'rb-textbox-type-header', content: '<h2 class="rb-header">Lorem ipsum puttum baneradi four ure bannerum</h2>'});
    });
  },
